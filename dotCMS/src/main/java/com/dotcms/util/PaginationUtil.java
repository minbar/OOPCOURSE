...
public class PaginationUtil {
    ...
    private static String getUrl(final String urlBase, final String filter, final int page, final int perPage,
		...
		final Map<String, String> params = populateParams(filter, page, perPage, orderBy, direction);

		if (extraParams != null) {
			populateExtraParams(extraParams, params);
		}
		return getBuffer(urlBase, params).toString();
}

	@NotNull
	private static Map<String, String> populateParams(String filter, int page, int perPage, String orderBy, OrderDirection direction) {
	...
	private static StringBuilder getBuffer(String urlBase, Map<String, String> params) {
    ...
    private static void populateExtraParams(Map<String, Object> extraParams, Map<String, String> params) {
